  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-between h-[67px] md:h-[101px]">
        {/* Logo with washi texture background — overflows navbar via negative bottom margin */}
        <Link to="/" className="flex items-center px-2 md:px-4 py-2 md:py-3 -mb-4 md:-mb-7 relative z-10" style={{
