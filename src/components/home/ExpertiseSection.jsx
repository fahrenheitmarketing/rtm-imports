        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {SERVICES.map((service, idx) => (
            <motion.div
              ...
              style={{ borderColor: 'rgba(244,196,48,0.45)', background: '#FFFCF5', backgroundImage: 'linear-gradient(rgba(255,252,245,0.5), rgba(255,252,245,0.5)), url(https://media.base44.com/images/public/69dd75d09559acb6fb908761/fddd80646_paper-texture.jpg)', backgroundSize: 'cover' }}
            >
