...
export default function HeroSection() {
  return (
    <section
      ...
      style={{
        background: '#0A2454',
        backgroundImage: 'radial-gradient(ellipse at 20% 50%, rgba(20,60,130,0.3) 0%, rgba(8,28,80,0.55) 70%), url(https://media.base44.com/images/public/69dd75d09559acb6fb908761/67555098b_Group7.jpg)',
